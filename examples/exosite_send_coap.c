 ...
 *
 *  @note
 *- Make sure that the "Counter" data resource is added to your
...
int main(int argc, char *argv[])
{
    ...
    info_log(DEBUG_APPLICATION, ("Coap send example\n"));
    /** Create new instance */
